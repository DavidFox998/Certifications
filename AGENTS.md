# AGENTS.md — Certifications

## Role: META / AUDIT

**Cluster:** Infrastructure

**Core claim:** Cross-cluster certification and audit ledger — anchors all cluster proofs to a single signed record
...
Look for `REPOS.md`, `certificates/`, or `MASTER_EQUATIONS.md`.
